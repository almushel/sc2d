...
bool collib2d_check_point_line_intersect(float point_x, float point_y, float line_start_x, float line_start_y, float line_end_x, float line_end_y, bool segment);